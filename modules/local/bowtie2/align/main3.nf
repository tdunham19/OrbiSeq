process BOWTIE2_ALIGN {
    ...
    bowtie2 -x \$INDEX -q ${reads} --local --qc-filter --score-min C,120,1 --maxins 700 --time --no-unal --al-conc ${meta.id}.conc_hits.fastq --threads 24 -S ${meta.id}_new_draft_seq.sam
